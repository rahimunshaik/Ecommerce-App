...
import { faInr, faShoppingCart } from "@fortawesome/free-solid-svg-icons";
...
export default function CartItems() {
  ...
  let totalDiscount = 0;//set to 0 for now
  ...
  return (
    <div className="container-sm d-flex flex-column flex-lg-row mt-4 gap-3">
      ...
      <PriceDetail className="bg-white p-5 d-flex flex-column gap-2">
        ...
        <span className="fs-5 pb-2 fw-bold">Price Details <FontAwesomeIcon icon={faShoppingCart} /> </span>
        
        <div className="d-flex justify-content-between">
          <span>Price ({totalItem} item)</span>
          <span><FontAwesomeIcon icon={faInr} /> {totalPrice}</span>
        </div>
        <div className="d-flex justify-content-between">
          <span>Discount</span>
          <span>
